...
public class Book : MonoBehaviour {
    ...
    public GameObject pointt1;
    public GameObject pointsb;
    public GameObject pointebr;
    public GameObject pointebl;
    ...
    public void UpdateBookRTLToPoint(Vector3 followLocation)
    {
        ...
        Debug.Log("T0_T1_Angle" + T0_T1_Angle);
        ...
        pointt1.transform.SetParent(ClippingPlane.transform.parent);
        pointt1.transform.position = BookPanel.TransformPoint(t1);

        //page position and angle
        Right.transform.position = BookPanel.TransformPoint(c);
        Debug.Log("Right.transform.position" + Right.transform.position);
        pointc.transform.SetParent(Right.transform.parent,true);
        pointc.transform.position = BookPanel.TransformPoint(c);
